...
import { DownloadButton, Header, Input, Loader } from "@/components";
import { downloadImage, randomSurprisePrompt } from "@/utils";
        ...
        <section className="w-full max-w-8xl mx-auto">
          <div>
            ...
            <p className="mt-2 text-[#666e75] text-base max-w-lg">
              Create visually stunning images generated by DALL-E AI and share
              then with the community. The only limit is your imagination.
            </p>
          </div>
          ...
          >
            ...
            >
              {photo ? (
                <img
                  ...
                  className={`object-contain ${
                    generatorLoading ? "opacity-40" : "opacity-100"
                  }`}
                />
              ) : (
                <img
              ...
              {photo && (
                <DownloadButton
                  className="w-8 h-8 absolute bottom-5 right-5 text-white p-1.5 rounded-full border-[1px] border-white font-black cursor-pointer"
                  onClick={() => downloadImage(`${Date.now()}`, photo)}
                />
              )}
